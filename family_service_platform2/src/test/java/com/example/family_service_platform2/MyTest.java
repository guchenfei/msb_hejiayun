...
public class MyTest {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("GuYinTai")
                .setOutputDir("/Users/guchenfei/IdeaProjects/msb_hejiayun/family_service_platform2/src/main/java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://guchenfei:3306/family_service_platform?serverTimezone=UTC")
                .setUsername("root").setPassword("GCFgcf106424");
        ...
        packageConfig.setParent("com.example").setMapper("mapper")
